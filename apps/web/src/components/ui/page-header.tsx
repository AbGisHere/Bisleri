...
export function PageHeader({ title, backHref = "/seller/dashboard" as const, backLabel }: PageHeaderProps) {
  const router = useRouter();
  const { t } = useLocale();

  const resolvedBackLabel = backLabel ?? t("pageHeader.backToDashboard");
